...
>
> This is `v0.2.0-alpha.1`: sharp enough to dogfood, honest about rough edges, and shipping with portable binaries so you can try it without a Node setup. On MA's internal alpha benchmark, local Qwen3-30B through LM Studio passes L0-L2 with 100% / 98.7% / 95.3%.
